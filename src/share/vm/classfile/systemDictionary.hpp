...
/*tony 09/12/2009 Detecting remote objects, Tony*/\
  template(remote_klass,java_rmi_Remote, Pre) \
/*  template(runnable_klass,java_lang_Runnable, Pre)*/ \
/*-tony 09/12/2009*/\
...
public:
 ...
 /*tony 09/12/2009 Detecting remote objects, Tony*/ 
  static bool remote_klass_loaded()         { return WK_KLASS(remote_klass) != NULL;}   //Added by Feng at Jan 27
//  static bool runnable_klass_loaded()         { return WK_KLASS(runnable_klass) != NULL;}  
