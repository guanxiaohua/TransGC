...
void TemplateTable::initialize() {
 ...
 //tony-> 2011/02/28 adding new bytecodes
  // PENG DU: marker bytecodes
  def(Bytecodes::_markerenter         , ubcp|____|clvm|____, vtos, vtos, markerenter         ,  _           );
  def(Bytecodes::_markerexit          , ubcp|____|clvm|____, vtos, vtos, markerexit          ,  _           );
  //<-tony 2011-02-28
  // JVM bytecodes
