...
class methodOopDesc : public oopDesc {
 ...
 //tony-> 2011/02/28 adding new bytecodes
   //@@PENG	
  bool _has_markers;  // true if the method has markers	
  //<-tony 2011-02-28
 public:
 //tony-> 2011/02/28 adding new bytecodes
  // @@PENG: marker & adaptive supports
  bool has_markers() const       { return _has_markers;  }	
  void set_has_markers(bool h)   { _has_markers = h;     }
  //<-tony 2011-02-28
