...
# endif
 ...
 //tony-> 2011/02/28 adding new bytecodes
  // @@PENG Marker Stubs
  static address _marker_enter_Java;
  static address _marker_exit_Java;
...
# endif
 ...
 //tony-> 2011/02/28 adding new bytecodes
  // @@PENG
  static address marker_enter_Java()                     { return _marker_enter_Java; }
  static address marker_exit_Java ()                     { return _marker_exit_Java;  }
 //<-tony 2011-02-28
...
# endif
 ...
 //tony-> 2011/02/28 adding new bytecodes
  // @@PENG
  static const TypeFunc* marker_handler_Type();
 //<-tony 2011-02-28
# ifdef ENABLE_ZAP_DEAD_LOCALS
