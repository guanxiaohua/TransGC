...
void initialize_marker_support(); //@@PENG DU
 //<-tony 2011-02-28
...
jint init_globals() {
  ...
  SharedRuntime::generate_stubs();
   //tony-> 2011/02/28 adding new bytecodes
  initialize_marker_support(); //@@PENG --> before universe2_init, which will 
                               //           load many system classes, which 
                               //           might have markers as well.
      //<-tony 2011-02-28
