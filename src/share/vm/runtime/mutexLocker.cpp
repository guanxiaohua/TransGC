...
//tony-> 2010-10-12 concurrency bug.
Monitor* TransGC_lock				=NULL;//the lock on the transGC related variables
  //<-tony 2010-10-12
#ifdef TIERED
...
Mutex*   tty_lock                     = NULL;
Mutex*   trans_lock				   =NULL; //by tony 2010-10-27 concurrency bug.
...
void mutex_init() {
  ...
  def(trans_lock                   ,  Mutex , nonleaf,       true ); // allow to lock in VM //by tony 2010-10-27 concurrency bug.
  ...
  def(TransGC_lock					, Monitor, nonleaf+1,    true);//by tony 2010-10-27 concurrency bug.
