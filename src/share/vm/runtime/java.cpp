...
//@@PENG
//void print_watcher_results();  // predicateRepository.cpp
 //<-tony 2011-02-28
...
void before_exit(JavaThread * thread) {
  ...
  if (Arguments::has_alloc_profile()) {
	...
	//by tony 2011/01/13 check the residuals. if transGC, we only iterate once, the whole heap.
