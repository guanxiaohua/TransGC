...
class Arguments : AllStatic {
 ...
 static	const char*  _transaction_start_method_string;
 static	const char*  _transaction_end_method_string;
 static	const char*  _transaction_parent_thread_name;
 static	int _transaction_start_method_position_in_string;
 static	int _transaction_end_method_position_in_string;
 //<-tony 2010-09-02
 ...
 public:
  ...
  //tony-> 2010-09-02 Parameterize the transaction boundary strings
   static const char* transaction_start_method_string()      { return _transaction_start_method_string; } 
   static int  transaction_start_separator(){return _transaction_start_method_position_in_string;} //separator means "." in the string, which separates the class and method in the string, we'll use in the SharedRuntime.
   static const char* transaction_end_method_string()      { return _transaction_end_method_string; }
   static int  transaction_end_separator(){return _transaction_end_method_position_in_string;}
   static const char* transaction_parent_thread_name()      { return _transaction_parent_thread_name; }
 //<-tony 2010-09-02
