...
class CardTableRS: public GenRemSet {
  ...
  enum ExtendedCardValue {
    ...
    localtoremote_card  = CardTableModRefBS::CT_MR_BS_last_reserved + 1,  //it is equal to youngergen_card. Feng
	/*-tony 02/06/2010 */
	
    cur_youngergen_and_prev_nonclean_card =
      CardTableModRefBS::CT_MR_BS_last_reserved + 6
  };
...
public:
  ...
  void inline_write_ref_field_gc(void* field, oop new_val) {
   ...
   /*tony 02/06/2010 Fixing Type Based GC, Tony*/ 
  //Feng
  void inline_write_ref_field_l2r_gc(void* field, oop new_val) {
    jbyte* byte = _ct_bs->byte_for(field);
    *byte = localtoremote_card;
  }
   /*-tony 02/06/2010 */
