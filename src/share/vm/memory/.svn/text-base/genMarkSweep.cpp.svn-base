...
//    rs->clear_into_younger(g, false /* perm */);//we pass a false here to avoid clearing cards for perm, because we encouter an assertion violation at verifyAfterGC
// on second thought, I choose to shift the pm_boundary in the verification of RS to be gen(2) instead of the original gen(1), let's give it a shot!
//solved after I modified the clear_into_younger() accordingly. //by tony 2010-09-16
 //<-tony 2010-08-19/
