...
class Generation: public CHeapObj {
 ...
 public:
  ...
  ////by tony 2010-07-29
  TransNewGeneration*  as_TransNewGeneration();
...
#undef Generation_SINCE_SAVE_MARKS_DECL
 ...
 //if so, skip it.
  virtual void oop_iterate_with_some_excluded(OopClosure* cl);
...
//  virtual  void space_iterate_with_some_excluded(SpaceClosure* blk, bool usedOnly = false);
 ...
 //tony-> 2010-11-04 analysing the residuals
  virtual void save_top_for_examine(){return;};
  virtual void examine_type_of_objects(){return;}
 //<-tony 2010-11-04
