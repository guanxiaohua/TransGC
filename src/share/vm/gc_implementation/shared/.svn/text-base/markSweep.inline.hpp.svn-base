...
if(DebugTypeGenGC){
	if(new_obj != NULL ||                         // is forwarding ptr?
           ...
           obj->is_shared())
		{
				...
				gclog_or_tty->print_cr("obj:%p in Generation %d",(HeapWord*)obj, Universe::heap()->addr_to_gen_id((HeapWord*)obj));
				gclog_or_tty->print_cr("new_obj:%p in Generation %d",(HeapWord*)new_obj,Universe::heap()->addr_to_gen_id((HeapWord*)new_obj));
