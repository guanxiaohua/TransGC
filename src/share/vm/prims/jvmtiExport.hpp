...
class JvmtiExport : public AllStatic {
 ...
 //tony-> 2010-12-01 printing out the allocation site of the residuals.
  static void post_set_scanning_residuals(JvmtiEnv* env,jboolean set) KERNEL_RETURN;
 //<-tony 2010-12-01
  ...
  static void post_print_trace_for_obj(JvmtiEnv* env,jobject object) KERNEL_RETURN;
