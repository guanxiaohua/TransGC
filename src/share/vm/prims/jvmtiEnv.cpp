...
JvmtiEnv::GetTag(jobject object, jlong* tag_ptr) {
  ...
  //printf("[ALLOC]<GetTag:oop:%p--jobject:%p>",(HeapWord*)o,(HeapWord*)object);
...
//  printf("JvmtiEnv::GetMethodDeclaringClass");
  NULL_CHECK(method_oop, JVMTI_ERROR_INVALID_METHODID);
  //  printf("JvmtiEnv::GetMethodDeclaringClass 1");
  (*declaring_class_ptr) = get_jni_class_non_null(method_oop->method_holder());
 //   printf("JvmtiEnv::GetMethodDeclaringClass 2");
  return JVMTI_ERROR_NONE;
